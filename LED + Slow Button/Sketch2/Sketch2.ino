...
void Set_timeSegment(int digit,int number,int Led)// 1 2 3
{
	if(Led == 0)
	{
		switch(digit)
	...
	if(Led == 1)
	{
		switch(digit)
		{
			...
			switch(number)
			{
				case 0: PORTB = (0 << SG1) | (0 << SG2) | (0 << SG6) | (1 << SG7) | (1 << SG8) | (1 << PB3); // 0
				PORTD = (0 << GR1d) | (0 << GR2d) | (1 << GR3d) | (0 << SG3) | (0 << SG4) | (0 << SG5);
				break;
				case 1: PORTB = (1 << SG1) | (0 << SG2) | (1 << SG6) | (1 << SG7) | (1 << SG8) | (1 << PB3); // 1
				PORTD = (0 << GR1d) | (0 << GR2d) | (1 << GR3d) | (0 << SG3) | (1 << SG4) | (1 << SG5);
				break;
				case 2: PORTB = (0 << SG1) | (0 << SG2) | (1 << SG6) | (0 << SG7) | (1 << SG8) | (1 << PB3); // 2
				PORTD = (0 << GR1d) | (0 << GR2d) | (1 << GR3d) | (1 << SG3) | (0 << SG4) | (0 << SG5);
				break;
				case 3: PORTB = (0 << SG1) | (0 << SG2) | (1 << SG6) | (0 << SG7) | (1 << SG8) | (1 << PB3); // 3
				PORTD = (0 << GR1d) | (0 << GR2d) | (1 << GR3d) | (0 << SG3) | (0 << SG4) | (1 << SG5);
				break;
				case 4: PORTB = (1 << SG1) | (0 << SG2) | (0 << SG6) | (0 << SG7) | (1 << SG8) | (1 << PB3); // 4
				PORTD = (0 << GR1d) | (0 << GR2d) | (1 << GR3d) | (0 << SG3) | (1 << SG4) | (1 << SG5);
				break;
				case 5: PORTB = (0 << SG1) | (1 << SG2) | (0 << SG6) | (0 << SG7) | (1 << SG8) | (1 << PB3); // 5
				PORTD = (0 << GR1d) | (0 << GR2d) | (1 << GR3d) | (0 << SG3) | (0 << SG4) | (1 << SG5);
				break;
				case 6: PORTB = (0 << SG1) | (1 << SG2) | (0 << SG6) | (0 << SG7) | (1 << SG8) | (1 << PB3);// 6
				PORTD = (0 << GR1d) | (0 << GR2d) | (1 << GR3d) | (0 << SG3) | (0 << SG4) | (0 << SG5);
				break;
				case 7: PORTB = (0 << SG1) | (0 << SG2) | (0 << SG6) | (1 << SG7) | (1 << SG8) | (1 << PB3);// 7
				PORTD = (0 << GR1d) | (0 << GR2d) | (1 << GR3d) | (0 << SG3) | (1 << SG4) | (1 << SG5);
				break;
				case 8: PORTB = (0 << SG1) | (0 << SG2) | (0 << SG6) | (0 << SG7) | (1 << SG8) | (1 << PB3);// 8
				PORTD = (0 << GR1d) | (0 << GR2d) | (1 << GR3d) | (0 << SG3) | (0 << SG4) | (0 << SG5);
				break;
				case 9: PORTB = (0 << SG1) | (0 << SG2) | (0 << SG6) | (0 << SG7) | (1 << SG8) | (1 << PB3);// 9
				PORTD = (0 << GR1d) | (0 << GR2d) | (1 << GR3d) | (0 << SG3) | (0 << SG4) | (1 << SG5);
				break;
			}
			case 2:
			...
			switch(number)
			{
				case 12: PORTB = (1 << SG1) | (0 << SG2) | (0 << SG6) | (0 << SG7) | (1 << SG8) | (1 << PB3);// H
				PORTD = (0 << SG3) | (1 << SG4) | (0 << SG5) | (1 << GR1d) | (0 << GR2d) | (0 << GR3d);
				break;
			}// H(12)
		}
...
void Set_7segment(int digit,int number,int Led) // 0 -> HT(10),LT(11) 1 -> -(10) 3 2 1
{
	switch(digit)
	{
		if(Led == 0)
	...
	if(Led == 1)
	{
		switch(digit)
		{
			...
			{
				case 0: PORTD = (0 << GR1d) | (0 << GR2d) | (0 << GR3d); break;
				case 10: PORTB = (1 << SG1) | (0 << SG2) | (0 << SG6) | (0 << SG7) | (1 << SG8) | (1 << PB3); // HT
				PORTD = (0 << SG3) | (1 << SG4) | (0 << SG5) | (0 << GR1d) | (1 << GR2d) | (0 << GR3d);
			...
			switch(number)
			{
				case 0: PORTB = (0 << SG1) | (0 << SG2) | (0 << SG6) | (1 << SG7) | (0 << SG8) | (1 << PB3);
				PORTD = (0 << GR1d) | (1 << GR2d) | (0 << GR3d) | (0 << SG3) | (0 << SG4) | (0 << SG5);
				break;
				case 1: PORTB = (1 << SG1) | (0 << SG2) | (1 << SG6) | (1 << SG7) | (0 << SG8) | (1 << PB3);
				PORTD = (0 << GR1d) | (1 << GR2d) | (0 << GR3d) | (0 << SG3) | (1 << SG4) | (1 << SG5);
				break;
				case 2: PORTB = (0 << SG1) | (0 << SG2) | (1 << SG6) | (0 << SG7) | (0 << SG8) | (1 << PB3);
				PORTD = (0 << GR1d) | (1 << GR2d) | (0 << GR3d) | (1 << SG3) | (0 << SG4) | (0 << SG5);
				break;
				case 3: PORTB = (0 << SG1) | (0 << SG2) | (1 << SG6) | (0 << SG7) | (0 << SG8) | (1 << PB3);
				PORTD = (0 << GR1d) | (1 << GR2d) | (0 << GR3d) | (0 << SG3) | (0 << SG4) | (1 << SG5);
				break;
				case 4: PORTB = (1 << SG1) | (0 << SG2) | (0 << SG6) | (0 << SG7) | (0 << SG8) | (1 << PB3);
				PORTD = (0 << GR1d) | (1 << GR2d) | (0 << GR3d) | (0 << SG3) | (1 << SG4) | (1 << SG5);
				break;
				case 5: PORTB = (0 << SG1) | (1 << SG2) | (0 << SG6) | (0 << SG7) | (0 << SG8) | (1 << PB3);
				PORTD = (0 << GR1d) | (1 << GR2d) | (0 << GR3d) | (0 << SG3) | (0 << SG4) | (1 << SG5);
				break;
				case 6: PORTB = (0 << SG1) | (1 << SG2) | (0 << SG6) | (0 << SG7) | (0 << SG8) | (1 << PB3);
				PORTD = (0 << GR1d) | (1 << GR2d) | (0 << GR3d) | (0 << SG3) | (0 << SG4) | (0 << SG5);
				break;
				case 7: PORTB = (0 << SG1) | (0 << SG2) | (0 << SG6) | (1 << SG7) | (0 << SG8) | (1 << PB3);
				PORTD = (0 << GR1d) | (1 << GR2d) | (0 << GR3d) | (0 << SG3) | (1 << SG4) | (1 << SG5);
				break;
				case 8: PORTB = (0 << SG1) | (0 << SG2) | (0 << SG6) | (0 << SG7) | (0 << SG8) | (1 << PB3);
				PORTD = (0 << GR1d) | (1 << GR2d) | (0 << GR3d) | (0 << SG3) | (0 << SG4) | (0 << SG5);
				break;
				case 9: PORTB = (0 << SG1) | (0 << SG2) | (0 << SG6) | (0 << SG7) | (0 << SG8) | (1 << PB3);
				PORTD = (0 << GR1d) | (1 << GR2d) | (0 << GR3d) | (0 << SG3) | (0 << SG4) | (1 << SG5);
				break;
			}
			break;
			...
			switch(number)
			{
				case 0: PORTB = (0 << SG1) | (0 << SG2) | (0 << SG6) | (1 << SG7) | (1 << SG8) | (1 << PB3);
				PORTD = (0 << GR1d) | (0 << GR2d) | (1 << GR3d) | (0 << SG3) | (0 << SG4) | (0 << SG5);
				break;
				case 1: PORTB = (1 << SG1) | (0 << SG2) | (1 << SG6) | (1 << SG7) | (1 << SG8) | (1 << PB3);
				PORTD = (0 << GR1d) | (0 << GR2d) | (1 << GR3d) | (0 << SG3) | (1 << SG4) | (1 << SG5);
				break;
				case 2: PORTB = (0 << SG1) | (0 << SG2) | (1 << SG6) | (0 << SG7) | (1 << SG8) | (1 << PB3);
				PORTD = (0 << GR1d) | (0 << GR2d) | (1 << GR3d) | (1 << SG3) | (0 << SG4) | (0 << SG5);
				break;
				case 3: PORTB = (0 << SG1) | (0 << SG2) | (1 << SG6) | (0 << SG7) | (1 << SG8) | (1 << PB3);
				PORTD = (0 << GR1d) | (0 << GR2d) | (1 << GR3d) | (0 << SG3) | (0 << SG4) | (1 << SG5);
				break;
				case 4: PORTB = (1 << SG1) | (0 << SG2) | (0 << SG6) | (0 << SG7) | (1 << SG8) | (1 << PB3);
				PORTD = (0 << GR1d) | (0 << GR2d) | (1 << GR3d) | (0 << SG3) | (1 << SG4) | (1 << SG5);
				break;
				case 5: PORTB = (0 << SG1) | (1 << SG2) | (0 << SG6) | (0 << SG7) | (1 << SG8) | (1 << PB3);
				PORTD = (0 << GR1d) | (0 << GR2d) | (1 << GR3d) | (0 << SG3) | (0 << SG4) | (1 << SG5);
				break;
				case 6: PORTB = (0 << SG1) | (1 << SG2) | (0 << SG6) | (0 << SG7) | (1 << SG8) | (1 << PB3);
				PORTD = (0 << GR1d) | (0 << GR2d) | (1 << GR3d) | (0 << SG3) | (0 << SG4) | (0 << SG5);
				break;
				case 7: PORTB = (0 << SG1) | (0 << SG2) | (0 << SG6) | (1 << SG7) | (1 << SG8) | (1 << PB3);
				PORTD = (0 << GR1d) | (0 << GR2d) | (1 << GR3d) | (0 << SG3) | (1 << SG4) | (1 << SG5);
				break;
				case 8: PORTB = (0 << SG1) | (0 << SG2) | (0 << SG6) | (0 << SG7) | (1 << SG8) | (1 << PB3);
				PORTD = (0 << GR1d) | (0 << GR2d) | (1 << GR3d) | (0 << SG3) | (0 << SG4) | (0 << SG5);
				break;
				case 9: PORTB = (0 << SG1) | (0 << SG2) | (0 << SG6) | (0 << SG7) | (1 << SG8) | (1 << PB3);
				PORTD = (0 << GR1d) | (0 << GR2d) | (1 << GR3d) | (0 << SG3) | (0 << SG4) | (1 << SG5);
				break;
				case 10: PORTB = (1 << SG1) | (1 << SG2) | (1 << SG6) | (0 << SG7) | (1 << SG8) | (1 << PB3);// -
				PORTD = (0 << GR1d) | (0 << GR2d) | (1 << GR3d) | (1 << SG3) | (1 << SG4) | (1 << SG5);
				break;
			}
			break;
...
void loop()
{
	...
	if(segment_mode == volt)
		{
			...
			{	
				int m = volt_tmp % 1000;
				if(bz_mode == BZOFF) Set_7segment(1,m % 10,0);
				else Set_7segment(1,m % 10,1);
				_delay_ms(1);
				m /= 10;
				if(bz_mode == BZOFF) Set_7segment(2,m % 10,0);
				else  Set_7segment(2,m % 10,1);
				_delay_ms(1);
				m /= 10;
				if(bz_mode == BZOFF) Set_7segment(3,m % 10,0);
				else Set_7segment(3,m % 10,1);
				_delay_ms(1);
			}
			else 
			{
	...
	if(segment_mode == Appear_CurrentTemper)
		{
			if(Vo != 0)
			{
				...
				if(bz_mode == BZOFF)Set_7segment(1,Tm % 10,0);
				else Set_7segment(1,Tm % 10,1);
				Tm /= 10;
				_delay_ms(1);
				if(bz_mode == BZOFF)Set_7segment(2,Tm % 10,0);
				else Set_7segment(2,Tm % 10,1);
				Tm /= 10;
				_delay_ms(1);
				if(bz_mode == BZOFF)Set_7segment(3,Tm % 10,0);
				else Set_7segment(3,Tm % 10,1);
				_delay_ms(1);
			}
			else 
			{
	...
	if(segment_mode == Appear_HighTemper)
	{
		if(flag & FLAG_Modename_bm )
		{
			...
			else if(bz_mode == BZON)
			{
				PORTB = (1 << SG1) | (0 << SG2) | (0 << SG6) | (0 << SG7) | (1 << SG8) | (1 << PB3); // H
				PORTD = (0 << SG3) | (1 << SG4) | (0 << SG5) | (0 << GR1d) | (1 << GR2d) | (0 << GR3d);
				_delay_ms(1);
				PORTB = (0 << SG1) | (1 << SG2) | (0 << SG6) | (0 << SG7) | (1 << SG8) | (1 << PB3); // E
				PORTD = (1 << SG3) | (0 << SG4) | (0 << SG5) | (1 << GR1d) | (0 << GR2d) | (0 << GR3d);
				_delay_ms(1);
			}
		}
		else
		{
			...
			{
				tmp = -1 * tmp;
				if(bz_mode == BZOFF)Set_7segment(3,10,0);
				else Set_7segment(3,10,1);
				tmp /= 10;
				_delay_ms(1);
				if(bz_mode == BZOFF)Set_7segment(1,tmp % 10,0);
				else Set_7segment(1,tmp % 10,1);
				_delay_ms(1);
				tmp /= 10;
				if(bz_mode == BZOFF)Set_timeSegment(2,tmp % 10,0);
				else Set_timeSegment(2,tmp % 10,1);
				_delay_ms(1);
			}
			else
			{
				...
				_delay_ms(1);
				tmp /= 10;
				if(bz_mode == BZOFF)Set_7segment(2,tmp % 10,0);
				else Set_7segment(2,tmp % 10,1);
				_delay_ms(1);
				tmp /= 10;
				if(bz_mode == BZOFF)Set_7segment(3,tmp % 10,0);
				else Set_7segment(3,tmp % 10,1);
				_delay_ms(1);
			}
		}
	}
	...
	if(segment_mode == Appear_LowTemper)
	{
		if(flag & FLAG_Modename_bm)
		{
			...
			{
				PORTB = (1 << SG1) | (1 << SG2) | (0 << SG6) | (1 << SG7) | (1 << SG8) | (1 << PB3); // L
				PORTD = (1 << SG3) | (0 << SG4) | (0 << SG5) | (0 << GR1d) | (1 << GR2d) | (0 << GR3d);
				_delay_ms(1);
				PORTB = (0 << SG1) | (1 << SG2) | (0 << SG6) | (0 << SG7) | (1 << SG8) | (1 << PB3); // E
				PORTD = (1 << SG3) | (0 << SG4) | (0 << SG5) | (1 << GR1d) | (0 << GR2d) | (0 << GR3d);
		...
		else
		{
			...
			if(tmpL < 0)
			{
				...
				tmpL /= 10;
				_delay_ms(1);
				if(bz_mode == BZOFF)Set_7segment(1,tmpL % 10,0);
				else Set_7segment(1,tmpL % 10,1);
				_delay_ms(1);
				tmpL /= 10;
				if(bz_mode == BZOFF)Set_timeSegment(2,tmpL % 10,0);
				else Set_7segment(2,tmpL % 10,1);
				_delay_ms(1);
			}
			else
			{
				...
				_delay_ms(1);
				tmpL /= 10;
				if(bz_mode == BZOFF)Set_7segment(2,tmpL % 10,0);
				else Set_7segment(2,tmpL % 10,1);
				_delay_ms(1);
				tmpL /= 10;
				if(bz_mode == BZOFF)Set_7segment(3,tmpL % 10,0);
				else Set_7segment(3,tmpL % 10,1);
				_delay_ms(1);
			}
		}
	}
	...
	if(segment_mode == Appear_Time)
	{
		...
		if(bz_mode == BZOFF)Set_timeSegment(3,12,0);//1 2 3
		else Set_timeSegment(3,12,1);
		_delay_ms(1);
		if(bz_mode == BZOFF)Set_timeSegment(2,tmpT % 10,0);
		else Set_timeSegment(2,tmpT % 10,1);
		_delay_ms(1);
		tmpT /= 10;
		if(bz_mode == BZOFF)Set_7segment(3,tmpT,0);// 3 2 1
		else Set_7segment(3,tmpT,1);
		_delay_ms(1);
	}
